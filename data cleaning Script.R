...
features <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/features.txt", col.names = c("n","functions"))
activities <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/activity_labels.txt", col.names = c("code", "activity"))

#reading testset 
subject_test <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/test/subject_test.txt", col.names = "subject")
x_test <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/test/X_test.txt", col.names = features$functions)
y_test <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/test/y_test.txt", col.names = "code")

#reading trainset
subject_train <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/train/subject_train.txt", col.names = "subject")
x_train <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/train/X_train.txt", col.names = features$functions)
y_train <- read.table("/home/samaaessa/Desktop/DS coursera/course 3/UCI HAR Dataset/train/y_train.txt", col.names = "code")
...
write.table(final_data, "/home/samaaessa/Desktop/DS coursera/course 3/FinalData.txt", row.name=FALSE)
